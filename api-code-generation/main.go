...
func main() {
	...
	for {
		...
		case reMatchClass.MatchString(line):
			...
			generateClass(output, baseStruct, className, url)
...
func generateClass(
	output io.Writer, base, className, url string,
) {
...
func generateMethod(
	output io.Writer, className, raw string, prevMethods []string,
) string {
